  ...
  return (
    <div className="text-left py-20 bg-blue-950 h-screen">
      <div className="grid pl-12">
        <p className="text-teal-300 text-xl m-5 ml-5 font-mono">Hi, my name is</p>
        ...
        <p className="text-lg text-slate-400 m-5">
          "I am a passionate front-end developer skilled in 
          <span className="text-teal-300 text-xl"> HTML, CSS, Tailwind CSS, JavaScript, TypeScript,</span> 
          and <span className="text-teal-300 text-xl">React</span>."
        </p>

        <p className="text-lg text-slate-400 m-5">
          "I specialize in crafting 
          <span className="text-teal-300 text-xl"> Responsive, User-friendly </span> 
          web applications with a focus on clean design and functionality."
        </p>
        <div>
          <a
            href={Resume}
            download="Resume"
            className="border-2 px-7 py-3 m-5 text-teal-300 border-teal-300 rounded-md text-xs font-mono hover:bg-teal-300 hover:text-blue-950 transition duration-300"
          >
            Check out my resume!
          </a>
        </div>
